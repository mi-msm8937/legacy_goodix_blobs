...
void FUN_0010488c(code *param_1)
...
void FUN_00105bc0(undefined4 param_1)
...
LAB_00106308:
      ...
      __android_log_print(3,"FingerGoodix",
                          "##################### %s, g_state=%d ,LongPressFlag = %d \n",
                          "NAV_DoNavInTA",param_1,LongPressFlag);
      if (param_1 == 1) goto LAB_001065d0;
      if (param_1 != 3) goto LAB_00106370;
      break;
    case 1:
    case 2:
      __android_log_print(3,"FingerGoodix",
...
switchD_00106224_caseD_4:
    ...
    if (navResult < 7) {
      if (navResult == 5) {
        ...
        __android_log_print(3,"FingerGoodix",&DAT_00110740);
        FUN_00105bc0(navResult);
        DoubleClickCount = 0;
        DoubleClickFlag = 0;
        gf_delete_timer(&gx_doubleclicktimerid);
        gf_delete_timer(&gx_longpresstimerid);
...

{
  ...
  if (param_1 == '\0') {
    ...
    __android_log_print(3,"FingerGoodix","%s %d status 0x%x g_mode %d g_state %d \n",
                        "gf_netlink_event",0x1b5,local_a,g_mode,g_state);
    if ((local_a >> 8 & 1) == 0) {
  ...
  if (iVar1 < 0) {
    ...
    do {
      ...
      if (iVar2 == -1) {
        ...
        if (*piVar3 == 0x6e) {
          if (DAT_001283c8 == '\x01') {
            pcVar4 = "Wait for finger down canceled.";
            uVar5 = 1;
            goto LAB_00107bf4;
          }
        }
    ...
    pcVar4 = "wait finger down time out.\n";
    uVar5 = 0x83;
LAB_00107bf4:
    __android_log_print(3,"FingerGoodix",pcVar4);
    g_state = 0;
    iVar1 = gf_enable_irq();
    if (iVar1 < 0) {
      __android_log_print(3,"FingerGoodix","Failed to set para in gf_enable_irq.\n");
...

{
  ...
  local_8 = ___stack_chk_guard;
  __android_log_print(3,"FingerGoodix",
                      "===> Wait Finger Up. g_up_ignore = %d. gFingerTouchFlag:%d\n",DAT_001283c0,
                      DAT_001283cc);
  if (DAT_001283cc == 1) {
    DAT_001283cc = 0;
    uVar5 = 0;
...

{
  ...
  if (uVar5 != g_mode) {
    ...
    if (uVar5 == 1) {
      g_state = 3;
      __android_log_print(3,"FingerGoodix","### download fdt get up cfg g_state %d \n",3);
      fnCa_Cfg_FdtDown_Up(0);
    }
    else if (bVar1) {
      g_state = 1;
...
{
  __android_log_print(3,"FingerGoodix","%s %d \n","device_set_recognize_flag",0x5b3);
  if (param_1 != 0x6e) {
    return 0;
  }
  DAT_001283c0 = 2;
...

{
  ...
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"gx_alipay_ta_start");
...

{
  ...
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"gx_ta_stop");
  if (g_ta_handle == 0) {
...

{
  ...
  lVar4 = 0;
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"gx_ta_start");
  do {
...

{
  ...
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"gx_alipay_ta_stop");
  if (g_alipay_handle == 0) {
...

{
  ...
  local_8 = ___stack_chk_guard;
  pthread_mutex_lock((pthread_mutex_t *)&DAT_001283f8);
  ...
  if ((param_2 == (void *)0x0) || (param_4 == (void *)0x0)) {
    ...
    pthread_mutex_unlock((pthread_mutex_t *)&DAT_001283f8);
  }
...
LAB_00109388:
        ...
        if (iVar3 != 0) goto LAB_001094f4;
        goto joined_r0x001094fc;
      }
...

{
  ...
  do {
    ...
    while( true ) {
      iVar1 = sem_wait((sem_t *)&DAT_00128420);
      if (iVar1 != -1) break;
      piVar3 = (int *)__errno();
      if (*piVar3 != 4) {
    ...
    uVar4 = _DAT_00128430;
    if ((int)_DAT_00128430 != 0) {
      DAT_00128460 = gx_alipay_ta_send_command
                               (DAT_00128438,DAT_00128440,DAT_00128448,DAT_00128450,DAT_00128458);
      uVar2 = sem_post((sem_t *)&DAT_00128468);
      uVar4 = (ulong)uVar2;
    }
...

{
  ...
  iVar1 = pthread_attr_init((pthread_attr_t *)&DAT_00128478);
  if (iVar1 != 0) {
    __android_log_print(6,"FingerGoodix","Failed in pthread_attr_init. ret = %d",iVar1);
    return;
  }
  iVar1 = pthread_attr_setstacksize((pthread_attr_t *)&DAT_00128478,0x40000);
  if (iVar1 == 0) {
    sem_init((sem_t *)&DAT_00128420,0,0);
    sem_init((sem_t *)&DAT_00128468,0,0);
    iVar1 = pthread_create(&DAT_001284b0,(pthread_attr_t *)&DAT_00128478,alipay_thread,(void *)0x0);
    if (iVar1 == 0) {
      DAT_00128430 = 1;
...

{
  ...
  if (DAT_001284b0 == 0) {
    ...
    DAT_00128430 = 0;
    DataMemoryBarrier(2,3);
    iVar1 = pthread_attr_destroy((pthread_attr_t *)&DAT_00128478);
    if (iVar1 == 0) {
      iVar1 = pthread_join(DAT_001284b0,(void **)&local_c);
    }
    else {
...

{
  ...
  DAT_00128438 = param_1;
  DAT_00128440 = param_2;
  DAT_00128448 = param_3;
  DAT_00128450 = param_4;
  DAT_00128458 = param_5;
  if (DAT_001284b0 == 0) {
    __android_log_print(6,"FingerGoodix","alipay thread doesn\'t run.");
    uVar2 = 0xffffffff;
  }
  else {
    sem_post((sem_t *)&DAT_00128420);
    while (iVar1 = sem_wait((sem_t *)&DAT_00128468), uVar2 = DAT_00128460, iVar1 == -1) {
      piVar3 = (int *)__errno();
      if (*piVar3 != 4) {
        __android_log_print(6,"FingerGoodix","%s Fatal Error When sem_wait, errno = %d.",
...
void FUN_00109edc(long param_1,undefined *param_2,int param_3)

{
  ...
  if (param_3 < 1) goto LAB_0010a0f8;
  if (param_3 == 1) {
    uVar4 = 0;
LAB_0010a128:
    uVar5 = 0;
...
LAB_0010a134:
    ...
    uVar4 = param_2[1];
    if (param_3 == 2) goto LAB_0010a128;
    uVar5 = param_2[2];
    if (param_3 == 3) goto LAB_0010a12c;
    uVar6 = param_2[3];
    if (param_3 == 4) goto LAB_0010a130;
    uVar7 = param_2[4];
    if (param_3 == 5) goto LAB_0010a134;
    uVar3 = param_2[5];
  }
  __android_log_print(3,"FingerGoodix",
...

{
  ...
  local_10 = 0;
  local_8 = ___stack_chk_guard;
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"fnCa_GetSessionID");
...

{
  ...
  local_8 = ___stack_chk_guard;
  local_18 = param_1;
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"fnCa_SetSessionID");
...

{
  ...
  if ((param_1 == (void *)0x0) || (param_2 == (uint *)0x0)) {
    ...
    *param_2 = 0;
    ...
    iVar2 = 0;
    if (param_3 != 1) goto LAB_0010b74c;
    uVar1 = *param_2;
    local_c = uVar1;
...

{
  ...
  if ((((local_14[0] < 5) && (param_2 != (int *)0x0)) && (param_3 != (undefined8 *)0x0)) &&
    ...
    if (__ptr == (int *)0x0) {
      ...
      pthread_mutex_lock((pthread_mutex_t *)&DAT_001284c8);
      ...
      if ((iVar1 == 0) && (*__ptr == 0)) {
        ...
        *param_3 = uVar3;
        ...
        if (iVar1 < 1) {
          uVar7 = 0xffffffff;
          pthread_mutex_unlock((pthread_mutex_t *)&DAT_001284c8);
        }
        else {
          local_c = iVar1;
    ...
    if (0 < local_38) {
      ...
      do {
        while( true ) {
          ...
          uVar4 = (undefined4)unaff_x26;
          if (local_38 <= iVar3) goto LAB_0010c648;
        }
        iVar3 = iVar3 + 1;
        iVar5 = iVar5 + 1;
      } while (iVar3 < local_38);
...

{
  ...
  uStack_418 = 0;
  local_40c = 0;
  FUN_00109edc("FnCa1, TEE auth token",auStack_408,0x25);
  FUN_00109edc("FnCa1, TEE auth hmac",auStack_3e3,0x20);
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      *param_4 = 0x28;
      ...
      FUN_00109edc("FnCa2, TEE auth token",&local_450,0x25);
      FUN_00109edc("FnCa2, TEE auth hmac",(long)&local_430 + 5,0x20);
      uVar2 = 0;
    }
    else {
      uVar2 = 0xffffffff;
...
undefined8 FUN_0010d400(long param_1,undefined8 param_2)
...
undefined8 FUN_0010d48c(undefined8 param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  if (param_3 == (undefined8 *)0x0) {
    ...
    *__s = 0x48574454;
    *(code **)(__s + 0x1c) = FUN_0010def4;
    *(code **)(__s + 0xac) = FUN_0010d400;
    *(code **)(__s + 0x20) = fnCa_OpenSession;
    *(code **)(__s + 0x22) = fnCa_CloseSession;
    *(code **)(__s + 0x24) = FUN_0010d960;
    *(code **)(__s + 0x26) = fnCa_Reset;
    *(code **)(__s + 0x28) = FUN_0010dc88;
    *(code **)(__s + 0x2a) = FUN_0010db04;
    *(code **)(__s + 0x2c) = fnCa_SetModeCancel;
    *(code **)(__s + 0x2e) = FUN_0010dee4;
    *(code **)(__s + 0x30) = fnCa_CancelRegister;
    *(code **)(__s + 0x32) = FUN_0010ded0;
    *(code **)(__s + 0x34) = FUN_0010dec0;
    *(code **)(__s + 0x36) = FUN_0010deb0;
    *(code **)(__s + 0x72) = fnCa_enroll_verify;
    *(code **)(__s + 0x38) = FUN_0010de94;
    *(code **)(__s + 0x3a) = fnCa_CancelRecognize;
    *(code **)(__s + 0x3c) = FUN_0010de84;
    *(code **)(__s + 0x3e) = FUN_0010de78;
    *(code **)(__s + 0x40) = FUN_0010de64;
    *(code **)(__s + 0x42) = FUN_0010de58;
    *(code **)(__s + 0x44) = fnCa_LoadFpAlogParams;
    *(code **)(__s + 0x6c) = FUN_0010de3c;
    *(code **)(__s + 0x6e) = FUN_0010de34;
    *(code **)(__s + 0x70) = FUN_0010de2c;
    *(code **)(__s + 0x46) = fnCa_DriverTest;
    *(code **)(__s + 0x76) = FUN_0010de14;
    *(code **)(__s + 0x78) = FUN_0010de04;
    *(code **)(__s + 0x7e) = fnCa_reg_from_bmp_cancel;
    *(code **)(__s + 0x7a) = FUN_0010ddf4;
    __s[1] = 0x100;
    *(code **)(__s + 0xa6) = FUN_0010ddb4;
    *(code **)(__s + 0x7c) = FUN_0010dda4;
    *(code **)(__s + 0x80) = FUN_0010dd98;
    *(code **)(__s + 0x82) = FUN_0010dd90;
    *(code **)(__s + 0x84) = FUN_0010dd84;
    *(code **)(__s + 0x8a) = FUN_0010dd70;
    *(code **)(__s + 0x8c) = FUN_0010dd68;
    *(code **)(__s + 0x86) = FUN_0010dd60;
    *(code **)(__s + 0x88) = fnCa_preprossor_init;
    *(code **)(__s + 0x9e) = FUN_0010dd24;
    *(code **)(__s + 0xa0) = FUN_0010dcec;
    *(code **)(__s + 0xa2) = FUN_0010dc94;
    *(code **)(__s + 0xa4) = set_fp_enabled;
    *(code **)(__s + 0x48) = FUN_0010d40c;
    *(code **)(__s + 0x4a) = FUN_0010d414;
    *(code **)(__s + 0x4c) = FUN_0010d41c;
    *(code **)(__s + 0x50) = FUN_0010dc4c;
    *(code **)(__s + 0x52) = FUN_0010dc14;
    *(code **)(__s + 0x54) = FUN_0010d424;
    *(code **)(__s + 0x56) = FUN_0010d438;
    *(code **)(__s + 0x58) = FUN_0010d464;
    *(code **)(__s + 0x5a) = FUN_0010dbd4;
    *(code **)(__s + 0x5c) = FUN_0010d42c;
    *(code **)(__s + 0x5e) = FUN_0010db9c;
    *(code **)(__s + 0x60) = FUN_0010db64;
    *(code **)(__s + 0x62) = FUN_0010db5c;
    *(code **)(__s + 100) = FUN_0010dacc;
    *(code **)(__s + 0x66) = FUN_0010da94;
    *(code **)(__s + 0x68) = FUN_0010da6c;
    *(code **)(__s + 0x6a) = FUN_0010da44;
    *(code **)(__s + 0x4e) = FUN_0010da3c;
    *(code **)(__s + 0x74) = FUN_0010da24;
    *(code **)(__s + 0x8e) = FUN_0010d9f0;
    *(code **)(__s + 0x96) = device_enable_spiclk;
    *(code **)(__s + 0x98) = device_disable_spiclk;
    *(code **)(__s + 0x90) = FUN_0010d9e0;
    *(code **)(__s + 0x92) = FUN_0010d9d8;
    *param_3 = __s;
    *(code **)(__s + 0x94) = FUN_0010d9d0;
    *(code **)(__s + 0x9a) = FUN_0010d994;
    *(code **)(__s + 0x9c) = FUN_0010d96c;
    *(code **)(__s + 0xa8) = FUN_0010d958;
...
void FUN_0010d960(undefined8 param_1,undefined4 param_2)
...
void FUN_0010d994(undefined8 param_1,undefined4 param_2)
...
void FUN_0010da24(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4,
...
void FUN_0010da3c(undefined8 param_1,undefined4 param_2)
...
void FUN_0010da94(undefined8 param_1,undefined8 param_2)
...
void FUN_0010dacc(undefined8 param_1,undefined8 param_2)
...
void FUN_0010db04(undefined8 param_1,undefined4 *param_2)
...
void FUN_0010db5c(undefined8 param_1,undefined4 param_2)
...
void FUN_0010db64(undefined8 param_1,undefined4 param_2)
...
void FUN_0010db9c(undefined8 param_1,undefined4 param_2)
...
void FUN_0010dbd4(undefined8 param_1,undefined param_2,undefined8 param_3)
...
void FUN_0010dc14(undefined8 param_1,undefined8 param_2)
...
void FUN_0010dc4c(undefined8 param_1,undefined4 param_2)
...
void FUN_0010dc88(undefined8 param_1,undefined4 param_2)
...
void FUN_0010dc94(undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4)
...
void FUN_0010dcec(undefined4 param_1)
...
void FUN_0010dd24(undefined4 param_1)
...
void FUN_0010dd60(undefined8 param_1,undefined4 param_2)
...
void FUN_0010dd68(undefined8 param_1,undefined8 param_2)
...
void FUN_0010dd70(undefined8 param_1,undefined8 param_2,undefined4 param_3)
...
void FUN_0010dd84(undefined8 param_1,undefined4 param_2,undefined8 param_3)
...
void FUN_0010dd90(undefined8 param_1,undefined8 param_2)
...
void FUN_0010dd98(undefined8 param_1,undefined8 param_2,undefined4 param_3)
...
void FUN_0010dda4(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4)
...
void FUN_0010ddb4(undefined8 param_1,undefined8 param_2,undefined4 param_3)
...
void FUN_0010ddf4(undefined8 param_1,undefined8 param_2,undefined4 param_3)
...
void FUN_0010de04(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4)
...
void FUN_0010de14(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                 undefined4 param_5)
...
void FUN_0010de2c(undefined8 param_1,undefined8 param_2)
...
void FUN_0010de34(undefined8 param_1,undefined8 param_2)
...
void FUN_0010de3c(undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined4 param_4,
                 undefined8 param_5,undefined8 param_6)
...
void FUN_0010de58(undefined8 param_1,undefined8 param_2,undefined4 param_3)
...
void FUN_0010de78(undefined8 param_1,undefined8 param_2,undefined8 param_3)
...
void FUN_0010de84(undefined8 param_1,undefined8 param_2,undefined4 param_3)
...
void FUN_0010de94(undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined4 param_4,
                 undefined8 param_5,undefined8 param_6)
...
void FUN_0010deb0(undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined4 param_4)
...
void FUN_0010dec0(undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4)
...
void FUN_0010ded0(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4)
...
void FUN_0010dee4(undefined8 param_1,undefined8 param_2)
...
undefined8 FUN_0010def4(void *param_1)
...

{
  ...
  iVar1 = pthread_attr_init((pthread_attr_t *)&DAT_001284f0);
  if (iVar1 != 0) {
    __android_log_print(3,"FingerGoodix","Failed in pthread_attr_init. ret = %d\n",iVar1);
    return;
  }
  iVar1 = pthread_attr_setstacksize((pthread_attr_t *)&DAT_001284f0,0x20000);
  if (iVar1 == 0) {
    iVar1 = pthread_create(&DAT_00128528,(pthread_attr_t *)&DAT_001284f0,netlink_thread,(void *)0x0)
    ;
    if (iVar1 == 0) {
      return;
    }
...

{
  ...
  if (DAT_00128528 != 0) {
    iVar1 = pthread_attr_destroy((pthread_attr_t *)&DAT_001284f0);
    if (iVar1 != 0) {
      __android_log_print(3,"FingerGoodix","Failed in pthread_attr_destory. ret = %d\n",iVar1);
    }
    iVar1 = pthread_join(DAT_00128528,&pvStack_10);
    if (iVar1 == 0) {
...

{
  ...
  uVar1 = 0;
  __android_log_print(3,"FingerGoodix",&DAT_00111650,"keymaster_ta_start");
...
void FUN_0010e6bc(char *param_1,byte *param_2,int param_3,int param_4)
...
void FUN_0010e808(char *param_1,ushort *param_2,int param_3,int param_4)
...
void FUN_0010e958(char *param_1,char *param_2)
...
void FUN_0010ea80(long param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  ...
  FUN_0010e808(acStack_508,param_1 + 0x94f8,param_4,param_5);
  sprintf(acStack_508,"%s%s_kr.csv",param_2,param_3);
  FUN_0010e808(acStack_508,param_1 + 0x78,param_4,param_5);
  sprintf(acStack_508,"%s%s_b.csv",param_2,param_3);
  uVar1 = FUN_0010e808(acStack_508,param_1 + 0x4ab8,param_4,param_5);
...
void FUN_0010ee28(char *param_1)
...
void FUN_0010eef4(char *param_1)
  ...
  if (1 < (int)sVar4) {
    ...
    do {
      while (*pcVar5 == '/') {
        ...
        *pcVar5 = '/';
        pcVar5 = pcVar5 + 1;
        if (pcVar5 == pcVar1) goto LAB_0010efc4;
      }
      pcVar5 = pcVar5 + 1;
    } while (pcVar5 != pcVar1);
  }
...

{
  ...
  case 8:
    ...
    FUN_0010ea80(param_1,&local_308,&uStack_108,param_3,param_4);
    sprintf((char *)&local_208,"%s%s_%s_calires.csv",&local_308,&uStack_108,param_5);
    FUN_0010e808(&local_208,param_1 + 0x37ce,param_3,param_4);
    sprintf((char *)&local_208,"%s%s_%s_databmp.csv",&local_308,&uStack_108,param_5);
    FUN_0010e6bc(&local_208,piVar2,param_3,param_4);
    ...
    FUN_0010e6bc(&local_208,piVar1,param_3,param_4);
...
LAB_0010f7ac:
    ...
    *(undefined *)(puVar8 + 1) = 0;
    uVar6 = FUN_0010e6bc(&local_208,piVar2,param_3,param_4);
    goto LAB_0010f410;
  case 2:
    FUN_0010ee28("/sdcard/gf_data/base/finger_base/");
    iVar4 = FUN_0010eef4("/sdcard/gf_data/base/finger_base/");
    if (iVar4 < 0) {
      __android_log_print(6,"FingerGoodix","[%s] make directory(%s) fail:%d","gf_dump_data",
      ...
      uVar6 = FUN_0010ea80(param_1,"/sdcard/gf_data/base/finger_base/",&uStack_108,param_3,param_4);
      if (*param_1 != 0) {
        DAT_001281d8 = 0;
      }
    }
  ...
  case 3:
  case 4:
    iVar4 = FUN_0010eef4("/sdcard/gf_data/test_sensor/");
    if (-1 < iVar4) {
      if (param_2 == 3) {
      ...
      *puVar8 = 0x7673632e;
      *(undefined *)(puVar8 + 1) = 0;
      uVar6 = FUN_0010e808(&local_208,param_1 + 0x253e,param_3,param_4);
      goto LAB_0010f410;
    }
  default:
    uVar6 = 0;
  ...
  case 5:
    ...
    iVar4 = FUN_0010eef4("/sdcard/gf_data/consistency/");
    if (-1 < iVar4) {
...
LAB_0010f4ec:
  ...
  case 9:
    ...
    iVar4 = FUN_0010eef4("/sdcard/gf_data/navigation/");
    if (-1 < iVar4) {
  ...
  case 10:
    ...
    FUN_0010ee28("/sdcard/gf_data/base/nav_base/");
    iVar4 = FUN_0010eef4("/sdcard/gf_data/base/nav_base/");
    if (-1 < iVar4) {
...
LAB_0010fab0:
        iVar1 = FUN_0010eef4(acStack_308);
        if (-1 < iVar1) {
          ...
          *puVar4 = 0x7478742e;
          *(undefined *)(puVar4 + 1) = 0;
          FUN_0010e958(acStack_108,acStack_208);
          pcVar3 = stpcpy(acStack_108,acStack_308);
          puVar4 = (undefined4 *)stpcpy(pcVar3,&DAT_00128540);
          *puVar4 = 0x7673632e;
          *(undefined *)(puVar4 + 1) = 0;
